  ...
  if (isEditing) {
    return (
      <select
        ...
        className="text-xs bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 text-slate-800 dark:text-slate-200 rounded-full px-3 py-1 focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer shadow-sm font-bold"
      >
...
export const ApplicationList: React.FC<ApplicationListProps> = ({
  ...
  if (applications.length === 0) {
    return (
      <div className="bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 rounded-xl p-12 text-center my-6 shadow-xs backdrop-blur-md">
        <div className="w-12 h-12 bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 rounded-xl flex items-center justify-center mx-auto mb-4">
          <Briefcase className="w-6 h-6 text-slate-400 dark:text-slate-400" />
        </div>
        <h3 className="text-lg font-bold text-slate-900 dark:text-white">No Job Applications Found</h3>
    ...
    <div className="bg-white dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden shadow-xs dark:shadow-xl my-6 backdrop-blur-md">
      <div className="overflow-x-auto">
        <table className="w-full text-left text-sm text-slate-700 dark:text-slate-300 border-collapse">
          <thead>
            <tr className="bg-slate-50 dark:bg-slate-800/80 border-b border-slate-200 dark:border-slate-700/80 text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">
              ...
              return (
                ...
                >
                  ...
                  <td className="py-3.5 px-4 min-w-[180px]">
                    <div className="font-bold text-slate-900 dark:text-white tracking-tight group-hover:text-blue-600 dark:group-hover:text-blue-400 transition truncate">
                      {app.company}
                    </div>
                  ...
                  <td className="py-3.5 px-4 whitespace-nowrap">
                    <span className="inline-block text-xs px-2.5 py-1 rounded-md font-semibold bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700">
                      {app.location}
                    </span>
                  </td>
                  ...
                  {/* Notes */}
                  <td className="py-3.5 px-4 max-w-[200px] text-xs text-slate-500 dark:text-slate-400 truncate">
                    {app.notes ? (
                  ...
                  <td className="py-3.5 px-4 whitespace-nowrap text-right">
                    <div className="flex items-center justify-end gap-2">
                      <button
                        onClick={() => onEdit(app)}
                        className="flex items-center gap-1 px-2.5 py-1.5 rounded-md text-xs font-semibold bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700 transition cursor-pointer"
